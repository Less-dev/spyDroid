...
public:
    ...
    virtual std::vector<Devices> getDevices() const = 0;

    // Método que retorna un dispositivo basado en un alias
    virtual std::vector<Devices> getDevice(const std::string& alias) const = 0;
};
...
public:
    ...
    std::vector<Devices> getDevices() const override;
    std::vector<Devices> getDevice(const std::string& alias) const override;
