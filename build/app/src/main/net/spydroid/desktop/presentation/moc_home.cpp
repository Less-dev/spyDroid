...
#include <memory>
#include "../../../../../../../../app/src/main/net/spydroid/desktop/presentation/home.h"
...
QT_MOC_LITERAL(1, 5, 11), // "goToProfile"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 12), // "searchDevice"
QT_MOC_LITERAL(4, 31, 20) // "handleVncButtonClick"

    },
    "Home\0goToProfile\0\0searchDevice\0"
    "handleVncButtonClick"
};
...
void Home::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->goToProfile(); break;
        case 1: _t->searchDevice(); break;
        case 2: _t->handleVncButtonClick(); break;
        default: ;
        }
        ...
        {
            using _t = void (Home::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Home::goToProfile)) {
                *result = 0;
                return;
            }
        }
